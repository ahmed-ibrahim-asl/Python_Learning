...
def miles_kiloMeters_converter(miles, output_var, convert_button):
    ...
    try:
        ...
        # Method can be used to change style of button
        # convert_button.configure(style='success.TButton')

    except tk.TclError:
        output_var.set("Please set valid Number")
        messagebox.showwarning("Warning", "Please set valid Number.")
...
def window_root():
    ...
    # Examples of themename -> yeti, journal, cosmo, litera
    window_root = ttk.Window(themename='cosmo')
    ...
    userInput_frame = ttk.Frame(master=window_root)
    ...
    convert_button = ttk.Button(
        ...
        command=lambda: miles_kiloMeters_converter(
            user_entry_int, output_string, convert_button)
